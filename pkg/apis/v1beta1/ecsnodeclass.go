...
type ECSNodeClassSpec struct {
	...
	// Role is the AliCloud identity that nodes use. This field is immutable.
	...
	// InstanceProfile is the AliCloud entity that instances use.
	...
	// +kubebuilder:validation:XValidation:message="tag contains a restricted tag matching karpenter.k8s.alicloud/ec2nodeclass",rule="self.all(k, k !='karpenter.k8s.alicloud/ec2nodeclass')"
	// +optional
	...
	// provisioned ECS nodes. For more information,
	// see Instance Metadata and User Data
	// TODO: Waiting for alicloud documentation to be updated
	// (https://docs.alicloud.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html)
	// in the Amazon Elastic Compute Cloud User Guide.
	//
	// Refer to recommended, security best practices
	// (https://alicloud.github.io/alicloud-eks-best-practices/security/docs/iam/#restrict-access-to-the-instance-profile-assigned-to-the-worker-node)
	...
	// Context is a Reserved field in ECS APIs
	// TODO: Waiting for alicloud documentation to be updated
	// https://docs.alicloud.amazon.com/AWSEC2/latest/APIReference/API_CreateFleet.html
	// +optional
...
type AMISelectorTerm struct {
	...
	// +optional
	Tags map[string]string `json:"tags,omitempty"`
	// ID is the ami id in ECS
	// +kubebuilder:validation:Pattern:="ami-[0-9a-z]+"
	// +optional
	ID string `json:"id,omitempty"`
	// Name is the ami name in ECS.
	// This value is the name field, which is different from the name tag.
	// +optional
	Name string `json:"name,omitempty"`
	// Owner is the owner for the ami.
	// You can specify a combination of AliCloud account IDs, "self", "amazon", and "alicloud-marketplace"
	// +optional
...
// Instance Metadata Service to provisioned ECS nodes.
...
type BlockDevice struct {
	...
	// TODO: Waiting for alicloud documentation to be updated
	// on the Nitro System (https://docs.alicloud.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances).
	...
	// TODO: Waiting for alicloud documentation to be updated
	// For more information, see Amazon EBS volume types (https://docs.alicloud.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html)
	// in the Amazon Elastic Compute Cloud User Guide.
...
const ECSNodeClassHashVersion = "v4"
...
func (in *ECSNodeClass) InstanceProfileName(clusterName, region string) string {
	return fmt.Sprintf("%s_%d", clusterName, lo.Must(hashstructure.Hash(fmt.Sprintf("%s%s", region, in.Name), hashstructure.FormatV2, nil)))
}

func (in *ECSNodeClass) InstanceProfileRole() string {
	return in.Spec.Role
}

func (in *ECSNodeClass) InstanceProfileTags(clusterName string) map[string]string {
...
func (in *ECSNodeClass) AMIFamily() string {
